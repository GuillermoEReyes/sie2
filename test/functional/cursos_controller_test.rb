...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { codigo: @curso.codigo, codigo_siguiente_curso: @curso.codigo_siguiente_curso, descripcion: @curso.descripcion, tipo: @curso.tipo }
    end
  ...
  test "should update curso" do
    put :update, id: @curso, curso: { codigo: @curso.codigo, codigo_siguiente_curso: @curso.codigo_siguiente_curso, descripcion: @curso.descripcion, tipo: @curso.tipo }
    assert_redirected_to curso_path(assigns(:curso))
  end
