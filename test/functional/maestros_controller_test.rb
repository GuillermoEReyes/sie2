...
class MaestrosControllerTest < ActionController::TestCase
  ...
  test "should create maestro" do
    assert_difference('Maestro.count') do
      post :create, maestro: { email: @maestro.email, login: @maestro.login, nombre: @maestro.nombre, password: @maestro.password }
    end
  ...
  test "should update maestro" do
    put :update, id: @maestro, maestro: { email: @maestro.email, login: @maestro.login, nombre: @maestro.nombre, password: @maestro.password }
    assert_redirected_to maestro_path(assigns(:maestro))
  end
