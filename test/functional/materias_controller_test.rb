...
class MateriasControllerTest < ActionController::TestCase
  ...
  test "should create materia" do
    assert_difference('Materia.count') do
      post :create, materia: { codigo: @materia.codigo, descripcion: @materia.descripcion, materiaTipo: @materia.materiaTipo, nivel: @materia.nivel, orden: @materia.orden }
    end
  ...
  test "should update materia" do
    put :update, id: @materia, materia: { codigo: @materia.codigo, descripcion: @materia.descripcion, materiaTipo: @materia.materiaTipo, nivel: @materia.nivel, orden: @materia.orden }
    assert_redirected_to materia_path(assigns(:materia))
  end
